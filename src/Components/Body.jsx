  ...
  return (
    <>
        ...
        <div id="totalCard">
          <div id="firstCard">
            <div className="eachCard">
              ...
              <h2 className="adSubHead">Brand Recognition</h2>
              <p id="adSubParagraph">
          ...
          <div className="secondCard">
            <div className="eachCard">
              ...
              <h2 className="adSubHead">Detailed Records</h2>
              <p id="adSubParagraph">
          ...
          <div id="thirdCard">
            <div className="eachCard">
              ...
              <h2 className="adSubHead">Fully Customizable</h2>
              <p id="adSubParagraph">
      ...
      <section id="boostSection">
        <h1 id="boostHead">Boost your links today</h1>
        <button id="boostButton">Get Started</button>
      </section>
    </>
  );
};
